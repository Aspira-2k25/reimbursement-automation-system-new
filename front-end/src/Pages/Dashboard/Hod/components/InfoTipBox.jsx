...
/**
 * InfoTipBox Component
 * Displays helpful tips and information for HOD users
 * Uses consistent styling with other role dashboards
 */
export default function InfoTipBox() {
  const title = "HOD Tip"
  const message = "As Head of Department, submit FDP certificates and research documentation within 7 days of submission to ensure faster processing. Your applications may require additional approval from Principal."
  return (
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm text-amber-700">HOD Pro Tip</span>
            </div>
