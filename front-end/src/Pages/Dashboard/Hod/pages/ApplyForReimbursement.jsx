...
const iconMap = {
  ScienceOutlined: (props) => <Atom {...props} className="text-green-600" />,
  SchoolOutlined: (props) => <GraduationCap {...props} className="text-green-600" />,
  Groups2Outlined: (props) => <Users {...props} className="text-green-600" />,
  FlightTakeoffOutlined: (props) => <PlaneTakeoff {...props} className="text-green-600" />,
}
...
const ApplyForReimbursement = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-green-50/30 page-content">
      ...
      <section className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-6 py-4 sm:py-6">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-green-100 text-green-700 text-xs sm:text-sm font-medium mb-3 sm:mb-4"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative p-4 sm:p-5 lg:p-6 h-full flex flex-col">
                      <motion.div
                        className="flex h-10 w-10 sm:h-12 sm:w-12 lg:h-14 lg:w-14 items-center justify-center rounded-lg sm:rounded-xl bg-gradient-to-br from-green-100 to-teal-100 mb-3 sm:mb-4 group-hover:scale-110 transition-transform duration-300"
                        whileHover={{ rotate: 5 }}
                      >
