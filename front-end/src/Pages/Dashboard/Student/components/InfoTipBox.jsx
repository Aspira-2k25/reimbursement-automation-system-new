        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-2">
              <span className="font-semibold" style={{color: 'var(--color-dark-gray)'}}>Student Tip</span>
              <div className="h-1 w-1 rounded-full" style={{backgroundColor: 'var(--color-dark-gray)'}}></div>
              <span className="text-sm" style={{color: 'var(--color-dark-gray)'}}>Pro Tip</span>
            </div>
            <p className="leading-relaxed" style={{color: 'var(--color-dark-gray)'}}>Upload clear receipts and approval letters. If your request shows 'At under Cordinator', watch notifications for any required actions.</p>
          </div>
