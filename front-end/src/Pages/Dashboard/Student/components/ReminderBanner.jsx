          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm" style={{color: 'var(--color-moss-olive)'}}>Deadline Alert</span>
              </div>
              <p className="mt-1 font-medium" style={{color: 'var(--color-moss-olive)'}}>Research Grant reimbursement window closes on 15th Sept 2025</p>
            </div>
          </div>
          <button
