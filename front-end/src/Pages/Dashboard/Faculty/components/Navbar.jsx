        ...
        <div className="flex h-14 sm:h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              <div
                className={`absolute right-0 top-full mt-2 w-64 sm:w-72 rounded-xl border border-white/30 bg-white/90 backdrop-blur-xl shadow-2xl shadow-slate-900/20 z-30 transition-all duration-300 ease-out ${
                  open 
                ...
                <div className="p-2">
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-slate-500">Manage your faculty account</span>
                    </div>
                  </button>
                  <button
                    onClick={() => {
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-xs text-slate-500">Sign out of your account</span>
                    </div>
                  </button>
                </div>
              </div>
