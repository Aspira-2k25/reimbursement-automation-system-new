...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-1/2 relative overflow-hidden flex items-center justify-center" style={{background: 'linear-gradient(135deg, #636B2F 0%, #BAC095 50%, #D4DE95 100%)'}}>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                style={{
                  background: 'linear-gradient(135deg, #636B2F 0%, #BAC095 50%, #D4DE95 100%)',
                  boxShadow: '0 4px 15px rgba(99, 107, 47, 0.3)'
                }}
                onMouseEnter={(e) => {
                  e.target.style.background = 'linear-gradient(135deg, #3D4127 0%, #A8B085 50%, #C8D485 100%)';
                }}
                onMouseLeave={(e) => {
                  e.target.style.background = 'linear-gradient(135deg, #636B2F 0%, #BAC095 50%, #D4DE95 100%)';
                }}
              >
                {isLoading ? (
