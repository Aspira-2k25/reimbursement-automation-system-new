...
StudentFormSchema.index({ email: 1 });
StudentFormSchema.index({ email: 1, status: 1 }); // User dashboard queries
...
StudentFormSchema.index({ createdAt: -1 }); // Sorting by newest creation
