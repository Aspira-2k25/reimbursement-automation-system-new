...
// Example: F-COMP-NPT-2026-001 (Faculty, Comp Dept, NPTEL, 2026, Global Sequence 1)
...
FormSchema.index({ applicantType: 1 });
...
FormSchema.index({ createdAt: -1 }); // Sorting by newest creation
